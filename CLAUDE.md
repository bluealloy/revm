...
2. A framework for building custom EVM variants (like Optimism, now maintained externally in [ethereum-optimism/optimism](https://github.com/ethereum-optimism/optimism))
