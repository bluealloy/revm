...
> **Note:** The `op-revm` crate has been moved to [ethereum-optimism/optimism](https://github.com/ethereum-optimism/optimism) and will be removed from this repository. Historical contributions to `crates/op-revm` will be ported to [ethereum-optimism/optimism](https://github.com/ethereum-optimism/optimism).
...
Revm offers two primary applications: firstly, it functions as an executor where users can set up block info and process mainnet transactions; secondly, it acts as a framework that facilitates the extension and support of different EVM variants such as [op-revm](https://github.com/ethereum-optimism/optimism).
