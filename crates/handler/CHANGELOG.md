...
## [43.0.3](https://github.com/bluealloy/revm/compare/revm-handler-v43.0.2...revm-handler-v43.0.3) - 2026-09-21

### Other

- updated the following local packages: revm-state, revm-context-interface, revm-context, revm-database, revm-database-interface, revm-interpreter, revm-precompile
