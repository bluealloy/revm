...
## [9.0.1](https://github.com/bluealloy/revm/compare/revm-handler-v9.0.0...revm-handler-v9.0.1) - 2025-08-07

### Other

- updated the following local packages: revm-bytecode, revm-context-interface, revm-state, revm-database-interface, revm-context, revm-database, revm-interpreter
