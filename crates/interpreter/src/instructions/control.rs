...
mod test {
    ...
    use revm_primitives::{bytes, eof::TypesSection, Bytecode, Eof, EthereumWiring, PragueSpec};
    ...
    #[test]
    fn rjump() {
        let table = make_instruction_table::<DummyHost<EthereumWiring>, PragueSpec>();
    ...
    fn callf_retf_stop() {
        ...
        let mut host = DummyHost::<EthereumWiring>::default();
