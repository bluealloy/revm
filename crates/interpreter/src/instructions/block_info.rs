...
pub fn chainid<WIRE: IT, H: Host + ?Sized>(context: Icx<'_, H, WIRE>) -> Result {
...
pub fn coinbase<WIRE: IT, H: Host + ?Sized>(context: Icx<'_, H, WIRE>) -> Result {
    push!(
        context.interpreter,
...
pub fn timestamp<WIRE: IT, H: Host + ?Sized>(context: Icx<'_, H, WIRE>) -> Result {
...
pub fn block_number<WIRE: IT, H: Host + ?Sized>(context: Icx<'_, H, WIRE>) -> Result {
...
pub fn difficulty<WIRE: IT, H: Host + ?Sized>(context: Icx<'_, H, WIRE>) -> Result {
    if context
        .interpreter
        .runtime_flag
        .spec_id()
...
pub fn gaslimit<WIRE: IT, H: Host + ?Sized>(context: Icx<'_, H, WIRE>) -> Result {
    push!(context.interpreter, context.host.gas_limit());
    Ok(())
}

/// EIP-3198: BASEFEE opcode
pub fn basefee<WIRE: IT, H: Host + ?Sized>(context: Icx<'_, H, WIRE>) -> Result {
...
pub fn blob_basefee<WIRE: IT, H: Host + ?Sized>(context: Icx<'_, H, WIRE>) -> Result {
...
pub fn slot_num<WIRE: IT, H: Host + ?Sized>(context: Icx<'_, H, WIRE>) -> Result {
