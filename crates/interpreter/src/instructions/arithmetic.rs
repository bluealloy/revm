...
pub fn add<WIRE: InterpreterTypes, H: ?Sized>(context: InstructionContext<'_, H, WIRE>) -> bool {
...
pub fn mul<WIRE: InterpreterTypes, H: ?Sized>(context: InstructionContext<'_, H, WIRE>) -> bool {
...
pub fn sub<WIRE: InterpreterTypes, H: ?Sized>(context: InstructionContext<'_, H, WIRE>) -> bool {
    //gas!(context.interpreter, gas::VERYLOW);
    popn_top!([op1], op2, context.interpreter);
...
pub fn div<WIRE: InterpreterTypes, H: ?Sized>(context: InstructionContext<'_, H, WIRE>) -> bool {
    //gas!(context.interpreter, gas::LOW);
    popn_top!([op1], op2, context.interpreter);
    if !op2.is_zero() {
...
pub fn sdiv<WIRE: InterpreterTypes, H: ?Sized>(context: InstructionContext<'_, H, WIRE>) -> bool {
    //gas!(context.interpreter, gas::LOW);
    popn_top!([op1], op2, context.interpreter);
...
pub fn rem<WIRE: InterpreterTypes, H: ?Sized>(context: InstructionContext<'_, H, WIRE>) -> bool {
    //gas!(context.interpreter, gas::LOW);
    popn_top!([op1], op2, context.interpreter);
    if !op2.is_zero() {
...
pub fn smod<WIRE: InterpreterTypes, H: ?Sized>(context: InstructionContext<'_, H, WIRE>) -> bool {
    //gas!(context.interpreter, gas::LOW);
    popn_top!([op1], op2, context.interpreter);
...
pub fn addmod<WIRE: InterpreterTypes, H: ?Sized>(context: InstructionContext<'_, H, WIRE>) -> bool {
...
///
/// Pops three values from stack and pushes (a * b) % n.
pub fn mulmod<WIRE: InterpreterTypes, H: ?Sized>(context: InstructionContext<'_, H, WIRE>) -> bool {
    //gas!(context.interpreter, gas::MID);
    popn_top!([op1, op2], op3, context.interpreter);
...
pub fn exp<WIRE: InterpreterTypes, H: ?Sized>(context: InstructionContext<'_, H, WIRE>) -> bool {
