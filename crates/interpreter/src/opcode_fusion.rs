...
use crate::{
    interpreter_types::{Immediates, Jumps, MemoryTr, StackTr},
    ...
    IW: InterpreterTypes<Stack: StackTr, Memory: MemoryTr, Bytecode: Jumps + Immediates>,
{
    ...
    let push_val = primitives::U256::try_from_be_slice(slice).unwrap_or(primitives::U256::ZERO);
    ...
    match next_opcode {
        ...
        opcode::SHL => {
            ...
            let result = if push_val >= primitives::U256::from(256) {
