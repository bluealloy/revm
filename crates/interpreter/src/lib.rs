...
#![cfg_attr(feature = "tail_call", feature(explicit_tail_calls))]
#![cfg_attr(feature = "tail_call", feature(rust_preserve_none_cc))]
#![cfg_attr(feature = "tail_call", allow(incomplete_features))]
