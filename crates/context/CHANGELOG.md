...
## [41.0.1](https://github.com/bluealloy/revm/compare/revm-context-v41.0.0...revm-context-v41.0.1) - 2026-06-29

### Other

- updated the following local packages: revm-state, revm-database-interface, revm-context-interface, revm-database
