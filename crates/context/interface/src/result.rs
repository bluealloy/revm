...
mod tests {
    ...
    fn test_final_refunded_with_floor_gas() {
        ...
        let gas = ResultGas::new(100000, 50000, 10000, 0, 0, 0);
        ...
        let gas = ResultGas::new(100000, 50000, 10000, 45000, 0, 0);
