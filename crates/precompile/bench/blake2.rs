...
pub fn add_benches(group: &mut BenchmarkGroup<'_, criterion::measurement::WallTime>) {
    ...
    let inputs = [
        hex!(""),
    ...
    // Benchmark with 4 rounds (most common case)
    group.bench_function("blake2/4_rounds", |b| {
        let input = &inputs[0]; // 4 rounds
        b.iter(|| {
    ...
    // Benchmark just the compression function with random round counts
