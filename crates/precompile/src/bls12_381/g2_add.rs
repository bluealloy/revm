...
fn g2_add_precompile(input: &[u8], gas_limit: u64, reservoir: u64) -> PrecompileOutput {
    call_eth_precompile(g2_add, input, gas_limit, reservoir)
}
...
pub fn g2_add(input: &[u8], gas_limit: u64) -> PrecompileEthResult {
