    ...
    pub fn homestead() -> &'static Self {
        ...
        INSTANCE.get_or_init(|| {
            let fun = [
                ...
                ec_ops::EC_HASH,
                ec_ops::EC_EQUAL,
                ec_ops::EC_IS_INFINITY,
                ec_ops::EC_IS_VALID,
                ec_ops::EC_SUM_OF_PRODUCTS,
                ec_ops::EC_PAIRING,
                ec_ops::SCALAR_ADD,
                ec_ops::SCALAR_MUL,
                ec_ops::SCALAR_NEG,
                ...
                ec_ops::SCALAR_EQUAL,
                ec_ops::SCALAR_HASH,
                ec_ops::SCALAR_IS_VALID,
                ec_ops::SCALAR_FROM_WIDE_BYTES,
                ec_ops::SCALAR_IS_ZERO,
                ec_ops::ECDSA_VERIFY,
                ec_ops::SCHNORR_VERIFY1,
                ec_ops::SCHNORR_VERIFY2,
                ec_ops::BLS_VERIFY,
            ]
            .into_iter()
            .map(From::from)
