...
use revm_primitives::{block::Block, hex_literal::hex, Bytes, Env};
...
fn run<BLOCK: Block>(input: &Bytes, gas_limit: u64, env: &Env<BLOCK>) -> PrecompileResult {
...
mod tests {
    ...
    fn basic_test() {
        ...
        let gas = 50000;
        let env: Env<BlockEnv> = Env::default();
