...
#[inline]
pub fn p1_msm_bytes(
    point_scalar_pairs: impl Iterator<Item = Result<G1PointScalarPair, PrecompileError>>,
...
#[inline]
pub fn p2_msm_bytes(
    point_scalar_pairs: impl Iterator<Item = Result<G2PointScalarPair, PrecompileError>>,
) -> Result<[u8; G2_LENGTH], PrecompileError> {
