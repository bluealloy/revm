...
pub mod add {
    ...
    pub const ISTANBUL: Precompile =
        Precompile::new(PrecompileId::Bn128Add, ADDRESS, |input, gas_limit| {
...
pub mod mul {
    ...
    /// Bn128 mul precompile with ISTANBUL gas rules
    pub const ISTANBUL: Precompile =
        Precompile::new(PrecompileId::Bn128Mul, ADDRESS, |input, gas_limit| {
...
pub mod pair {
    ...
    /// Bn128 pair precompile with ISTANBUL gas rules
    pub const ISTANBUL: Precompile =
        Precompile::new(PrecompileId::Bn128Pairing, ADDRESS, |input, gas_limit| {
            run_pair(
                input,
