...
use revm_interpreter::opcode::{InstructionTables, InstructionTrait};
...
// pub fn inspector_instruction<'a, INSP, DB>(
//     instruction: impl InstructionTrait<Evm<'a, INSP, DB>>,
// ) -> BoxedInstruction<Evm<'a, INSP, DB>>
// where
//     for<'b> DB: Database + 'b,
//     for<'c> INSP: GetInspector<DB> + 'c,
// {
//     Box::new(
