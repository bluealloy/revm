...
## [22.0.1](https://github.com/bluealloy/revm/compare/revm-v22.0.0...revm-v22.0.1) - 2025-04-11

### Other

- updated the following local packages: revm-primitives, revm-bytecode, revm-state, revm-context, revm-interpreter, revm-precompile, revm-handler, revm-inspector, revm-database-interface, revm-context-interface, revm-database
