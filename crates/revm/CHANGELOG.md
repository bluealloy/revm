...
## [28.0.2](https://github.com/bluealloy/revm/compare/revm-v28.0.1...revm-v28.0.2) - 2025-08-19

### Other

- updated the following local packages: revm-bytecode, revm-database-interface, revm-context-interface, revm-database, revm-interpreter, revm-state, revm-context, revm-handler, revm-inspector
