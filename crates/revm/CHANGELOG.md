...
## [23.1.1](https://github.com/bluealloy/revm/compare/revm-v23.1.0...revm-v23.1.1) - 2025-05-17

### Other

- updated the following local packages: revm-primitives, revm-state, revm-database-interface, revm-context-interface, revm-context, revm-database, revm-interpreter, revm-precompile, revm-handler, revm-bytecode, revm-inspector
