...
## [1.0.0](https://github.com/bluealloy/revm/releases/tag/revm-state-v1.0.0) - 2024-12-06
...
- inline more `AccountInfo` fns and add docs ([#1819](https://github.com/bluealloy/revm/pull/1819))
