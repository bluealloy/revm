(module
  ...
  (import "fluentbase_v1alpha" "_crypto_keccak256" (func $fluentbase_sdk::bindings::_crypto_keccak256::h300ac647e966a8c4 (type 0)))
  (import "fluentbase_v1alpha" "_sys_read" (func $fluentbase_sdk::bindings::_sys_read::he28ad825855b6201 (type 0)))
  (func $fluentbase_codec::encoder::Encoder::encode_to_vec::h416db5aafac11a67 (type 3) (param i32 i32)
  ...
  (func $__rust_alloc_error_handler (type 4) (param i32)
    ...
    call $__rdl_oom
    unreachable)
  (func $_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$::into::h7b014491d7c9abc0 (type 3) (param i32 i32)
    (local i32 i32)
    i32.const 0
    i32.load8_u offset=66436
    drop
  ...
  (func $main (type 5)
    ...
    i32.const 16
    i32.add
    call $fluentbase_sdk::bindings::_crypto_keccak256::h300ac647e966a8c4
    local.get 0
    i32.const 48
    i32.add
    i32.const 24
    ...
    i32.const 48
    i32.add
    call $_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$::into::h7b014491d7c9abc0
    local.get 0
    i32.const 100
    i32.add
    local.get 0
    i32.const 84
    i32.add
    call $fluentbase_codec::encoder::Encoder::encode_to_vec::h416db5aafac11a67
    local.get 0
    i32.load offset=100
    local.get 0
    i32.load offset=108
