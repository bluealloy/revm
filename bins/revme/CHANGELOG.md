...
## [7.0.5](https://github.com/bluealloy/revm/compare/revme-v7.0.4...revme-v7.0.5) - 2025-07-15

### Other

- updated the following local packages: revm-primitives, revm, revm-bytecode, revm-state, revm-database-interface, revm-context-interface, revm-context, revm-database, revm-inspector, revm-statetest-types
