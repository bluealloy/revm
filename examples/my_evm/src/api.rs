...
where
    CTX: ContextSetters<Journal: JournalTr<FinalOutput = JournalOutput>> + Host,
{
...
where
    CTX: ContextSetters<Db: DatabaseCommit, Journal: JournalTr<FinalOutput = JournalOutput>> + Host,
{
...
where
    CTX: ContextSetters<Journal: JournalTr<FinalOutput = JournalOutput> + JournalExt> + Host,
