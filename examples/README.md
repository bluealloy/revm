...
* `cheatcode_inspector`: Example of implementing and using a custom cheatcode inspector.
* `custom_precompile_journal`: Example of a custom precompile with journal access integrated into a custom EVM.
